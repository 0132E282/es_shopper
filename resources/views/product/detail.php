    ...
    <form method="POST" action="ProductController.php?product=cart&&method=put&id-product=<?php echo $_GET['id-product'] ?>">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <h3 class="font-weight-semi-bold mb-4 show-price" data-value="<?=$product_detail['price']?>"></h3>
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <input type="submit" href="ProductController.php?product=add-cart&id-product=<?=$id_product?>" class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</input>
                </div>
